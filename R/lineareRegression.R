...
summary(lm(SMI~Forearm.girth.left..cm.,function_lineare_regression(Sexv="M")))
summary(lm(SMI~Forearm.girth.left..cm. + Age,function_lineare_regression(Sexv="M")))
summary(lm(SMI~Forearm.girth.left..cm.+ Age + Education_cat + Physical.Activity_cat + Diet_cat,function_lineare_regression(Sexv="M")))
summary(lm(SMI~Thigh.girth.left..horizontal...cm.,function_lineare_regression(Sexv="M")))
summary(lm(SMI~Thigh.girth.left..horizontal...cm. + Age,function_lineare_regression(Sexv="M")))
summary(lm(SMI~Thigh.girth.left..horizontal...cm.+ Age + Education_cat + Physical.Activity_cat + Diet_cat,function_lineare_regression(Sexv="M")))
...
summary(lm(SMI~Forearm.girth.left..cm.,function_lineare_regression(Sexv="F")))
summary(lm(SMI~Forearm.girth.left..cm. + Age,function_lineare_regression(Sexv="F")))
summary(lm(SMI~Forearm.girth.left..cm.+ Age + Education_cat + Physical.Activity_cat + Diet_cat,function_lineare_regression(Sexv="F")))
summary(lm(SMI~Thigh.girth.left..horizontal...cm.,function_lineare_regression(Sexv="F")))
summary(lm(SMI~Thigh.girth.left..horizontal...cm. + Age,function_lineare_regression(Sexv="F")))
summary(lm(SMI~Thigh.girth.left..horizontal...cm.+ Age + Education_cat + Physical.Activity_cat + Diet_cat,function_lineare_regression(Sexv="M")))
